	...
	<div class="col-md-12">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							{{ Form::open(array('url'=>'admin/client', 'class'=>'form-horizontal')) }} 
								<div class="form-body">
									...
									<div class="form-group @if ($errors->has('office'))has-error @endif">
										...
										* </span></label>
										<div class="col-md-4">
											<input type="text" name="office" placeholder="No." class="form-control" value="{{ Input::old('office') }}" />
									...
									<div class="form-group @if ($errors->has('contact'))has-error @endif">
										...
										* </span></label>
										<div class="col-md-4">
											<input type="text" name="contact" placeholder="Name" class="form-control" value="{{ Input::old('contact') }}" />
									...
									<div class="form-group @if ($errors->has('mobile'))has-error @endif">
											...
											* </span>
											...
											<div class="col-md-4">
												<input type="text" name="mobile" placeholder="Mobile" class="form-control" value="{{ Input::old('mobile') }}" />
									...
									<div class="form-group @if ($errors->has('join_date'))has-error @endif">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="join_date" placeholder="Date" class="form-control datepicker" value="{{ (Input::old('join_date'))?Input::old('join_date'):date('d-m-Y') }}" />
									...
									<div class="form-group @if ($errors->has('fax'))has-error @endif">
										...
										<div class="col-md-4">
											<input type="text" name="fax" placeholder="No." class="form-control" value="{{ Input::old('fax') }}" />
									...
									<div class="form-group @if ($errors->has('website'))has-error @endif">
										...
										<div class="col-md-4">
											<input type="text" name="website" placeholder="Link" class="form-control" value="{{ Input::old('website') }}" />
